...
from torch.optim.lr_scheduler import _LRScheduler, ReduceLROnPlateau  # type: ignore

from basic.utils.registry import SCHEDULER_REGISTRY


'''
Modified from BasicSR(https://github.com/XPixelGroup/BasicSR/tree/master/basicsr/models/lr_scheduler.py)
'''
